...
* https://https://huanzhang89.github.io/yieldfarming/
...
async function main() {
    ...
    const rewardPoolAddr = "0x01877A9b00AE3c7101525721464F3e5840e07F49";
    const rewardTokenAddr = "0x28cb7e841ee97947a86B06fA4090C8451f64c0be";
    const balancerPoolTokenAddr = "0x8194EFab90A290b987616F687Bc380b041A2Cc25";
    ...
    const approveTENDAndStake = async function () {
        ...
        console.log(parseFloat(allowedBPT));
        console.log(currentBPT);

        if (parseFloat(allowedBPT / 1e18) < parseFloat(currentBPT / 1e18)) {
            showLoading();
    ...
    _print_link(`Exit and claim ${earnedYFFI} ${rewardTokenTicker}`, exit);
    _print("");
